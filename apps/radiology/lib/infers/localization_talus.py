...
class LocalizationSpine(BasicInferTask):
    """
    This provides Inference Engine for pre-trained talus localization (UNet) model.
    """
    ...
    def __init__(
        ...
        labels=None,
        dimension=3,
        description="A pre-trained model for volumetric (3D) talus localization from CT image",
        **kwargs,
    ):
        super().__init__(
            path=path,
